...
public class GovernmentDepartmentController {
	...
	@DeleteMapping("/{government_department_id}")
	...
	@PutMapping("/{government_department_id}/{government_department_name}")
	public ResultDO updateDepartment(
			@PathVariable long government_department_id, @PathVariable String government_department_name )
	{
